<?xml version="1.0" encoding="UTF-8"?><railo-configuration pw="" version="4.3"><cfabort/>
...
<rest/><gateways/><orm/><cache default-object="defObj"><connection class="railo.runtime.cache.ram.RamCache" custom="timeToIdleSeconds=0&amp;timeToLiveSeconds=0" name="defObj" read-only="false" storage="false"/></cache></railo-configuration>